  ...
  module Model
    ...
    module ClassMethods
      ...
      def has_paper_trail(options = {})
        ...
        @paper_trail_versions_order = "#{PaperTrail.timestamp_field} ASC, #{self.version_key} ASC"
        has_many self.versions_association_name, -> { order(@paper_trail_versions_order) },
